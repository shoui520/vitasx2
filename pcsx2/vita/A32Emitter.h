...
namespace VitaA32
{
	...
	public:
		...
		bool EmitLdrbImm12PostIndex(unsigned rd, unsigned rn, u16 offset);
		...
		bool EmitStrbImm12PostIndex(unsigned rd, unsigned rn, u16 offset);
		...
		bool EmitVcvtF32S32D(unsigned dd, unsigned dm, unsigned fractional_bits = 0);
		bool EmitVcvtS32F32D(unsigned dd, unsigned dm, unsigned fractional_bits = 0);
		bool EmitVcvtF32S32Q(unsigned qd, unsigned qm, unsigned fractional_bits = 0);
		bool EmitVcvtS32F32Q(unsigned qd, unsigned qm, unsigned fractional_bits = 0);
		...
		bool EmitVaddF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVsubF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVmulF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVmlaF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVmlsF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVmulF32DByLane(unsigned dd, unsigned dn, unsigned dm, unsigned lane);
		bool EmitVmlaF32DByLane(unsigned dd, unsigned dn, unsigned dm, unsigned lane);
		bool EmitVmlsF32DByLane(unsigned dd, unsigned dn, unsigned dm, unsigned lane);
		...
		bool EmitVmlaF32Q(unsigned qd, unsigned qn, unsigned qm);
		bool EmitVmlsF32Q(unsigned qd, unsigned qn, unsigned qm);
		bool EmitVmulF32QByLane(unsigned qd, unsigned qn, unsigned dm, unsigned lane);
		bool EmitVmlaF32QByLane(unsigned qd, unsigned qn, unsigned dm, unsigned lane);
		bool EmitVmlsF32QByLane(unsigned qd, unsigned qn, unsigned dm, unsigned lane);
		bool EmitVrecpeF32D(unsigned dd, unsigned dm);
		bool EmitVrecpsF32D(unsigned dd, unsigned dn, unsigned dm);
		bool EmitVrsqrteF32D(unsigned dd, unsigned dm);
		bool EmitVrsqrtsF32D(unsigned dd, unsigned dn, unsigned dm);
		...
		bool EmitVextI8D(unsigned dd, unsigned dn, unsigned dm, u8 byte_offset);
	...
	private:
		...
		bool m_write_domain_open = false;
	...
	u32 EncodeVcvtF32S32D(unsigned dd, unsigned dm, unsigned fractional_bits = 0);
	u32 EncodeVcvtS32F32D(unsigned dd, unsigned dm, unsigned fractional_bits = 0);
	u32 EncodeVcvtF32S32Q(unsigned qd, unsigned qm, unsigned fractional_bits = 0);
	u32 EncodeVcvtS32F32Q(unsigned qd, unsigned qm, unsigned fractional_bits = 0);
